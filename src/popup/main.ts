    ...
    chrome.runtime.sendMessage(
      ...
      ({
        ...
        document.getElementById("duration").textContent =
          duration || "NOT FOUND";
        document.getElementById("total-hr").textContent =
          `${checkNaN(totalClosedHR)} / ${checkNaN(totalHR)} (${checkNaN(
            remainingHours
          )} - ${checkNaN(totalPercent)}%)` || "NOT FOUND";
        document.getElementById("qtd-closed").textContent =
          totalClosed || "NOT FOUND";
        document.getElementById("qtd-new").textContent =
          totalNew || "NOT FOUND";
        document.getElementById("qtd-new-hr").textContent =
          totalNewHR || "NOT FOUND";
        ...
        document.getElementById(
          "qtd-total"
        ).textContent = `${totalOfTotalTypes} (${Object.entries(totalTypes)
